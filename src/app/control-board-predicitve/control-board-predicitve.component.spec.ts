...
describe('ControlBoardPredicitveComponent', () => {
  let component: ControlBoardPredicitveComponent;
  let fixture: ComponentFixture<ControlBoardPredicitveComponent>;
  ...
  beforeEach(async () => {
    ...
    fixture = TestBed.createComponent(ControlBoardPredicitveComponent);
